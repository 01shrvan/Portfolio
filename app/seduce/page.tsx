                        ...
                        <AnimatePresence>
                            {!exposed ? (
                                ...
                                >
                                    ...
                                    <p className="text-xl mb-4">Type "expose" in the command below:</p>
                                    <form onSubmit={handleCommandSubmit} className="flex items-center bg-[#ECE0C8] text-[#2C3E50] p-4 rounded-lg shadow-md">
